...
function checkDelete(){
 ...
 <div class=main-content>
     ...
     <div class=" col-xs-9">
        <h3><center><span><b>Bank Record</b></span></center>
    </h3>
        <table id="grid"></table>
     </div>
<!--      <div class=" col-xs-3">
     ...
     <script>
                ...
                url: "<?=site_url("accounts/bank_json/")?>",

                dataType: "JSON",

                data: { zoneParent: "bank" },
...
<div class="footer-buttons" style="position:absolute; left: 70%; bottom:81%">
                 <a href="<?=site_url("accounts/deposite/")?>" class="btn btn-primary btn-round btn-lg" data-title="New Transation" data-toggle="tooltip" data-original-title="" title="Deposit"><i class="fa fa-plus"></i></a>
            </div>
            <?php } ?>