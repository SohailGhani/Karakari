                                            ...
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    ...
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        ...
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Name</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Items</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">Paid</th>
                                                        ...
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Total</th>
...
//                                                     SORT_ASC($results);
                                                ...
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><?=$result->saleDate?></td>
                                                    <td class="sorting_1"><?=$result->invoice?></td>
                                                    <td class="sorting_1"><?=$result->name?></td>
                                                    <td class="r_quantity"><?=$result->itemNames?></td>
                                                    <td class="r_cash"><?=$result->paid?></td>
                                                    <td class="r_amount_paid"><?=$result->paidBy?></td>                                                    
                                                    <td class="r_total"><?=$result->depositeAmount?></td>
                                                    <td class="r_balance"><?=$result->balance?></td>
                                                </tr>
                                                 <?php endforeach; ?>
                                                <tr role="row" class="odd" style="border-top: 3px solid #000">
                                                    <td><b>Total</b></td>
                                                    <td id="t_total"></td>
                                                    <td id="t_total_amount"><b>Cash</b></td>
                                                    <td id="t_cash"></td>
                                                    <td id=""><b>Balance</b></td>
                                                    <td id="t_balance"></td>
                                                    <td id=""><b></b></td>
                                                </tr>
<!--                                                <tr role="row" class="odd" style="border-top: 3px solid #000">
