                        ...
                        <div id="customers2_wrapper" class="dataTables_wrapper no-footer">
                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                ...
                                <tr role="row" style="border:1px solid #D5D5D5">
                                    ...
                                    <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Description</th>
                                    <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Paid Amount</th>
                                ...
                                foreach($results as $result): ?>
                                    ...
                                    <tr role="row" class="odd">
                                        <td class="sorting_1"><?=$result->date?></td>
                                        <td class="sorting_1"><?=$result->description?></td>
                                        <td class="sorting_1"><?=$result->paidAmount?></td>
