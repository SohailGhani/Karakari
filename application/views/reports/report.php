                                            ...
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    ...
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        ...
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Credit</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Debit</th>
...
//                                                     
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1"><?=$result->total?></td>
                                                    ...
                                                    <td class="r_balance"><?=$result->lastBalance?></td>
                                                </tr>
                                                 <?php endforeach; ?>
