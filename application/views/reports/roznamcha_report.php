                                            ...
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    ...
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        ...
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Account</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">Paid by</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Deposit</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Withdraw</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Balance</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Details</th>
                                                    </tr>
                                                </thead>
                                            <tbody>
                                                 <?php
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="r_quantity"><?=$result->bank_name?></td>
                                                    <td class="r_quantity"><?=$result->name?></td>
                                                    <td class="r_quantity"><?=$result->deposite?></td>
                                                    <td class="r_total_amount"><?=$result->withdraw?></td>
                                                    <td class="r_total_amount"><?=$result->balance?></td>
                                                    <td class="r_total_amount"><?=$result->comment?></td>
                                                    <?php
                                                        //calculations
                                                        $total_in+=$result->deposite;
                                                        $total_out+=$result->withdraw;
                                                    ?>
