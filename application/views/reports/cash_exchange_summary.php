                                    ...
                                    <div style="margin-top:28px">
                                        <form action="<?=$action?>" method="post">
                                            <div class="input-group col-xs-12"> 
                                                       <div class="col-xs-10">
                                                           <input type="date" name="date" class="form-control col-xs-12" required="" > </div>
                                ...
                                <div class="panel-body">
                                        <div id="customers2_wrapper" class="dataTables_wrapper no-footer">
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    <tr>
                                                        <th colspan="5" class="text-center"><?=$title?><span style="font-size:13px;"> [Date:<?= date('d-m-Y',strtotime($date)); ?> ]</span></h3></center></th>
                                                    </tr>
                                                    
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Currency</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Opening</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">IN</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">PKR</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">OUT</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">PK</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Closing</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Closing in PKR</th>
                                                    </tr>
                                                </thead>
                                            <tbody>
                                                 <?php
                                                     
                                                    foreach($currencies as $currency): $result=$this->report_model->get_cash_summary($currency->id,$date);?>
                                                
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><?=$currency->currency?></td>
                                                    <td class="sorting_1"><?=$result['opening']?></td>
                                                    <td class="r_quantity"><?=$result['in_currency']?></td>
                                                    <td class="r_total_amount"><?=$result['in_PKR']?></td>
                                                    <td class="r_amount_paid"><?=$result['out_currency']?></td>                                                    
                                                    <td class="r_balance"><?=$result['out_PKR']?></td>
                                                    <td class="r_balance"><?=$result['closing']?></td>
                                                    <td class="r_balance"><?=$result['closing_pkr']?></td>
...
<!--                                                <tr role="row" class="odd" style="border-top: 3px solid #000">
                                                    <td><b>Total</b></td>
                                                    <td id="t_quantity"></td>
                                                    <td id="t_total_amount"></td>
                                                    <td id="t_amount_paid"></td>
                                                    <td id="t_balance"></td>
