                                            ...
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    ...
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        ...
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Stock In</th>
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Item Name</th>
                                                    </tr>
                                                </thead>
                                            <tbody>
                                                 <?php
//                                                     
                                                ...
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><?=$reload->inDate?></td>
                                                    <td class="sorting_1"><?=$reload->quantity?></td>
                                                    <td class="sorting_1"><?=$reload->itemName?></td>
