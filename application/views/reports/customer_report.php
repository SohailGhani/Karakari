                                            ...
                                            <div class="input-group col-md-7 pull-right"> <span class="input-group-addon" id="basic-addon1"><i class="fa fa-search"></i></span>
                                                       ...
                                                       <div class="col-md-2">    
                                                           <select name="selection" class="form-control">
                                                                ...
                                                                <option value="<?=$row->acId?>"><?=$row->name?> </option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                       </div>
                                                       <div class="col-md-2">
                                        ...
                                        <div id="customers2_wrapper" class="dataTables_wrapper no-footer">
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    ...
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        ...
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">In</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Out</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    <td class="r_quantity"><?=date(('d/m/Y'),strtotime($result->entrydate))?></td>
                                                    <td class="r_quantity"><?=$result->name?></td>
                                                    <td class="r_quantity"><?=$result->deposit?></td>
                                                    <td class="r_total_amount"><?=$result->withdraw?></td>
                                                    <td class="r_total_amount"><?=$result->balance?></td>
                                                    <?php
                                                        //calculations
                                                        $total_in+=$result->deposit;
