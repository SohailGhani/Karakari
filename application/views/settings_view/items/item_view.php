        ...
        dataSource: dataSource,
            ...
            },
            {
                ...
                title: "Quantity"
                    ...
                    {
                        template:"<div><a href='<?=  site_url('Settings/reload_add')?>/#:data.itemId#' class='btn btn-link btn-round' data-title='Reload'><span style='color:orange; font-size:20px;' class='pull-left fa fa-plus'></span></a><a href='<?=  site_url('Settings/search_reload')?>/#:data.itemId#' class='btn btn-link btn-round' data-title='History'><span style='color:orange; font-size:20px;' class='pull-left fa fa-history'></span></a> <a href='<?=  site_url('Settings/item_edit')?>/#:data.itemId#' class='btn btn-link btn-round' data-title='Edit'><span style='color:orange; font-size:20px;' class='pull-left fa fa-edit'></span></a><a href='<?=  site_url("Settings/item_delete")?>/#:data.itemId#' onclick='return checkDelete()' class='btn btn-link btn-round' data-title='Delete item'><span style='color:darkred; font-size:20px;' class='pull-right fa fa-trash'></span></a></div>",
                     title:"Actions"
                    }
