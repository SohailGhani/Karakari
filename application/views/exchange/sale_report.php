                                ...
                                <div class="panel-heading" style="background-color:#26C6DA">
                                    ...
                                    <div class="pull-right" style="margin-top:-28px">
                                        <form action="<?=$action?>" method="post">
                                            <div class="input-group col-md-7 pull-right"> <span class="input-group-addon" id="basic-addon1"><i class="md md-event-available"></i></span>
                                                       <div class="col-md-4">
                                                           <input type="date" name="from" class="form-control datepicker" value="<?=set_value('from')?>"> </div>
                                                       <div class="col-md-4">
                                                           <input type="date" name="to" value="<?=set_value('to')?>" class="form-control timepicker"> </div>
                                                       <div class="col-md-2">    
                                                       </div>
                                                       <div class="col-md-2">
                                ...
                                <div class="panel-body">
                                        <div id="customers2_wrapper" class="dataTables_wrapper no-footer">
                                            <table id="customers2" class="table datatable dataTable no-footer" role="grid" aria-describedby="customers2_info">
                                                <thead>
                                                    <tr>
                                                        <th colspan="10"><b style="font-size:16px">Site:</b> <?=$title?><span style="font-size:13px;">[ Date:<?= " from :".date('d-m-Y',strtotime($from))." To :".date('d-m-Y',strtotime($to)); ?> ]</span></h3></center></th>
                                                    </tr>
                                                    
                                                    <tr role="row" style="border:1px solid #D5D5D5">
                                                        <th  tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Car Name</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">Quantity</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Total Amount</th>
                                                        <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending">Amount Paid</th>
                                                    ...
                                                    <th tabindex="0" aria-controls="customers2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column ascending"></th>
                                            ...
                                            <tbody>
                                                 <?php
                                                     ...
                                                     $earned=0;
                                                     $remit=0;
                                                    foreach($cars as $car): $result=$this->Report_model->get_sale_report($car->carId,$from,$to); if($result['quantity']>0):?>
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><?=$car->car_name.' ('.$this->base_model->get_color_name_by_carid($car->carId),')'?></td>
                                                    <td class="r_quantity"><?=$result['quantity']?></td>
                                                    <td class="r_total_amount"><?php $remit+=$result['quantity']*$car->car_price;$earned+=$result['total_amount'];echo $result['total_amount']?></td>
                                                    <td class="r_amount_paid"><?=$result['amount_paid'];?></td>                                                    
                                                    <td class="r_balance"><?=$result['total_amount']-$result['amount_paid']?></td>
