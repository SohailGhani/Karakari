                ...
                <div class="row">
                    <div class="col-md-4"> 
                        <div class="widget bg-white no-padding"> 
                            <a href="<?=site_url('exchange/exchanges_info')?>" class="block text-center relative p15"> 
                                <span class="fa fa-exchange"style="font-size: 100px"></span>
                                <div class="h5 mb0"><strong>Exchanges</strong> 
                                </div> 
                            </a> 
