 ...
 <div class=main-content>
     ...
     <div class="col-xs-4 img-circle">
         <div class="widget bg-white no-padding"> 
             <a href="<?=  site_url("accounts/transactions_info/$account->acId")?>" class="block text-center relative p15"> 
                            ...
                            <div class="widget bg-blue mb0 text-center no-radius"> 
                                <div class="widget-details"> 
                                 ...
                                 <div class="widget-details"> 
                                     ...
                                     <a href="<?=site_url("accounts/account_edit/$account->acId")?>" class="small bold text-uppercase">Update Info</a> </div>
                                 <div class="widget-details"> 
                                    <div class="h5 no-margin"><span class=" fa fa-trash"></span></div> 
                                     <a href="<?=site_url("accounts/account_delete/$account->acId")?>" class="small bold text-uppercase">Delete Account</a> 
                                </div> 
                            </div> 
                        </div>
...
<div class="footer-buttons" style="position:absolute; left: 95%; bottom:83%">
                <a href="<?=site_url('accounts/account_add')?>" class="btn btn-primary btn-round btn-lg" data-title="New Sale" data-toggle="tooltip" data-original-title="" title=""><i class="fa fa-plus"></i></a>
            </div>
            <?php } ?>