...
<div class=main-content>
    ...
    <div class=" col-xs-9">
        <h3><center><span><b>Payees Record</b></span></center>
        </h3>
        <table id="grid"></table>
    </div>
    <div class=" col-xs-3">
            ...
            var dataSource = new kendo.data.DataSource({
                ...
                transport: {
                    ...
                    read: {
                        ...
                        url: "<?=site_url("accounts/payeesTransactions_json/$id")?>",

                        dataType: "JSON",

                        data: { zoneParent: "payeesTransactions" },
...
//            },
                    ...
                    {
                        template:"<div><a href='<?=  site_url("accounts/payeesTransaction_delete")?>/#:data.id#/#:data.acId#' onclick='return checkDelete()' class='btn btn-link btn-round' data-title='Delete item'><span style='color:darkred; font-size:20px;' class='pull-right fa fa-trash'></span></a></div>",
                        title:"Actions"
                    }
...
<?php if($this->session->userdata('type')!=3){ ?>
    <div class="footer-buttons" style="position:absolute; left: 70%; bottom:81%">
        <a href="<?=site_url("accounts/payeesTransaction_add/$id")?>" class="btn btn-primary btn-round btn-lg" data-title="New Transation" data-toggle="tooltip" data-original-title="" title="Add Sale"><i class="fa fa-plus"></i></a>
    </div>
<?php } ?>