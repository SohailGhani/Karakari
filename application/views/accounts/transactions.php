...
function checkDelete(){
 ...
 <div class=main-content>
     ...
     <div class=" col-xs-9">
        <h3><center><span><b>Sales Record</b></span></center>
    </h3>
        <table id="grid"></table>
     </div>
      <div class=" col-xs-3">
     ...
     <script>
                ...
                url: "<?=site_url("accounts/transactions_json/$id")?>",

                dataType: "JSON",

                data: { zoneParent: "transactions" },
...
//            },
            ...
            {
                template:"<div><a href='<?=  site_url("accounts/transaction_delete")?>/#:data.transId#/#:data.acId#' onclick='return checkDelete()' class='btn btn-link btn-round' data-title='Delete item'><span style='color:darkred; font-size:20px;' class='pull-right fa fa-trash'></span></a></div>",
                title:"Actions"
            }
...
<div class="footer-buttons" style="position:absolute; left: 70%; bottom:81%">
                <a href="<?=site_url("accounts/transaction_add/$id")?>" class="btn btn-primary btn-round btn-lg" data-title="New Transation" data-toggle="tooltip" data-original-title="" title="Add Sale"><i class="fa fa-plus"></i></a> <a href="<?=site_url("accounts/deposition_info/$id")?>" class="btn btn-primary btn-round btn-lg" data-title="New Transation" data-toggle="tooltip" data-original-title="" title="Deposit"><i class="fa fa-cc-discover"></i></a>
            </div>
            <?php } ?>